...
export class CarAdMapper {
  public static toResponseDto(
    ...
    const baseResponse = {
      ...
      priceUSD: Math.round(entity.priceUSD),
      priceEUR: Math.round(entity.priceEUR),
      priceUAH: Math.round(entity.priceUAH),
    ...
    if (options?.accType === EAccountType.PREMIUM) {
      return {
        ...
        averagePrice: Math.round(options.averagePrice),
        averageRegionPrice: Math.round(options.averageRegionPrice),
